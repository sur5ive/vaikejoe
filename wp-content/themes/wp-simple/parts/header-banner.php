            ...
            <div class="container">
                <div class="banner-wrap" data-sr='wait 0.4s, scale up 25%'>
                    ...
                    <?php if (nimbus_get_option('fp-banner-button-url') != '') { ?>
                        <div class="banner-link-button"><a href="<?php echo esc_url(nimbus_get_option('fp-banner-button-url')); ?>" target="_blank"><?php echo esc_html(nimbus_get_option('fp-banner-button-text')); ?></a></div>
                    <?php } ?>
                </div>      
            </div>    
        </section>  
